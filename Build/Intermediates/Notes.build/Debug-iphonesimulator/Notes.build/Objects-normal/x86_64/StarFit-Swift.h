...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StarFit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7StarFit11AppDelegate")
...
@interface Note (SWIFT_EXTENSION(StarFit))
@property (nonatomic, copy) NSString * _Nullable noteDescription;
@property (nonatomic, copy) NSData * _Nullable noteImage;
@property (nonatomic, copy) NSString * _Nullable noteName;
@end
...
- (void)retrieveNotes SWIFT_DEPRECATED_OBJC("Swift method 'noteTableViewController.retrieveNotes()' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (void)fetchNotesFromCoreDataWithCompletion:(void (^ _Nonnull)(NSArray<Note *> * _Nullable))completion SWIFT_DEPRECATED_OBJC("Swift method 'noteTableViewController.fetchNotesFromCoreData(completion:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
